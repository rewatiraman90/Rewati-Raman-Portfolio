        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Managing multi-cloud environments with 99.99% uptime. From
                resource provisioning to cost optimization and migrations,
                I build resilient cloud infrastructure at scale.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing CI/CD pipelines, streamlining deployments, and
                enforcing security best practices. Incident response,
                Grafana monitoring, and SLA-driven operations.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
